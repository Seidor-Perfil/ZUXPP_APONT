		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comseidorzuxppapont-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comseidorzuxppapont-display": {
								"semanticObject": "comseidorzuxppapont",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.seidor.zuxppapont",
									"url": sap.ui.require.toUrl("com/seidor/zuxppapont")
								}
							}
						}
					}
